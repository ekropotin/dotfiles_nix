...
vim.keymap.set("n", "<leader>1", function()
    ui.nav_file(1)
end, { desc = "jump to the [1] file in Harpoon" })
vim.keymap.set("n", "<leader>2", function()
    ui.nav_file(2)
end, { desc = "jump to the [2] file in Harpoon" })
vim.keymap.set("n", "<leader>3", function()
    ui.nav_file(3)
end, { desc = "jump to the [3] file in Harpoon" })
vim.keymap.set("n", "<leader>4", function()
    ui.nav_file(4)
end, { desc = "jump to the [4] file in Harpoon" })
